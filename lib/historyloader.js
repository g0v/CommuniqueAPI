...
app.run = function(){
    ...
    // getHackpadRevisions('NxMrvI4uYcP');
};
...
function getHackpadRevisions (padID) {
...
function storeHackpadData (timestamp) {
...
function storeHackpadAuthors (authors, padID, padAuthors) {
    var check = 0;
