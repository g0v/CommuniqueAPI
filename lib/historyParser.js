...
HistoryParser.prototype.runParser = function (padID, result) {
    ...
    historyParser.hackpadHistoryEntry['historyNum'] = result.length;
    hackpadEditNum += result.length;
    ...
    historyParser.emit('endOfParser', hackpadEditNum);
};
